...
class CodeWriter(object):
    def __init__(self, asm_filename):
        ...
        self.curr_file = None  # Nombre del archivo actual
        self.addresses = self.address_dict()  # Diccionario de direcciones
        self.line_count = 0  # Contador de líneas
        self.bool_count = 0  # Contador de booleanos
        self.call_count = 0  # Contador de llamadas a funciones

    def write_init(self):
        # Inicializa el puntero de la pila en 256 y llama a Sys.init
        self.write('@256')  
        self.write('D=A')  
        self.write('@SP')  
        self.write('M=D')  
    ...
    # Métodos de escritura para diferentes tipos de instrucciones

    def write_arithmetic(self, operation):
        # Diccionarios de operaciones aritméticas y saltos condicionales
        operations = {'add': 'M=M+D', 'sub': 'M=M-D', 'and': 'M=M&D', 'or': 'M=M|D', 'neg': 'M=-M', 'not': 'M=!M'}
        jumps = {'eq': 'D;JEQ', 'gt': 'D;JGT', 'lt': 'D;JLT'}
